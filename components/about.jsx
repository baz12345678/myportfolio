        ...
        transition={{duration: 0.5, delay: 1}}
         id='about' className='w-full px-[12%] py-10 scroll-mt-20 sm:t-[700px] '>
            ...
            className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
                ...
                className='flex-1'>
                    <p className='mb-10 max-w-2xl font-serif text-base'>   I'm a passionate Frontend Developer with a focus on building clean, responsive, and
                        user-friendly websites. I specialize in HTML, CSS, JavaScript, and modern frontend framework
                        like React  With a keen eye for detail, I always aim to provide seamless and engaging
                        user experiences.I enjoy solving complex problems and continuously learning new technologies. I am always looking
                        for ways to improve my skills and contribute to meaningful projects.</p>
