...
<motion.h4
                      ...
                      transition={{duration: 0.5, delay: 8}} className='text-center mb-2 text-lg font-sans' > What I offer
                      </motion.h4>
...
<motion.h2
 ...
 className='text-center text-5xl font-Ovo'>My Services
       ...
       <motion.div
                             initial={{y: 20, opacity: 0}}
                             whileInView={{y: 0, opacity: 1}}
                             transition={{duration: 0.5, delay: 1}} className='grid grid-cols-auto gap-6 my-10'>
